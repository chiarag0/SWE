...
public class ConcreteFactory extends EFactory {
    ...
    @Override
    public  void creaElemento(Boolean end, Boolean tipo, String nome, String casaEditrice, float costo, String serie, int capitolo, Boolean special,String size, int quantita){
        if(special)
